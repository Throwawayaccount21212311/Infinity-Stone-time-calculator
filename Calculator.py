...
def findupgrades(multiplier, number, price):
    cost = 0
    upgrades = -1
    if price == 0:
        return 100
...
extrbartime = round(31536000 / extrinf / (1.1 ** extrspeed), 15)
extrbarstart = extrbartime
speedbartime = round(31536000 / speedinf / (1.1 ** speedspeed), 15)
prodbartime = round(31536000 / prodinf / (1.1 ** prodspeed), 15)
speedincrease = 1.02
extramount = 0.01
...
print(timesecspeed / speedbartime)
